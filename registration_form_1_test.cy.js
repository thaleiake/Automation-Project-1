 ...
 */
        // 31.10.2023
describe('This is first test suite, Kristin Raudberg', () => {
    it('User can submit data only when valid mandatory values are added', () => {
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('#firstName').type('Kristin')
        cy.get('#lastName').type('Raudberg')
        cy.get('input[name="password"]').type('Kuusepuu123')
        cy.get('[name="confirm"]').type('Kuusepuu123')
